{
  mode: 'production',
  context: 'D:\\workspace\\Demo\\Vue\\hello-world',
  devtool: 'source-map',
  node: {
    setImmediate: false,
    dgram: 'empty',
  ...
  output: {
    path: 'D:\\workspace\\Demo\\Vue\\hello-world\\dist',
  ...
  resolve: {
    alias: {
      '@': 'D:\\workspace\\Demo\\Vue\\hello-world\\src',
    ...
    modules: [
      'node_modules',
      'D:\\workspace\\Demo\\Vue\\hello-world\\node_modules',
      ...
      /* config.module.rule('vue') */
      {
        ...
        use: [
          /* config.module.rule('vue').use('cache-loader') */
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: 'D:\\workspace\\Demo\\Vue\\hello-world\\node_modules\\.cache\\vue-loader',
              cacheIdentifier: '3f20a84c'
            }
          },
        ...
        oneOf: [
          /* config.module.rule('css').oneOf('vue-modules') */
          {
            ...
            use: [
              ...
              {
                loader: 'D:\\workspace\\Demo\\Vue\\hello-world\\node_modules\\mini-css-extract-plugin\\dist\\loader.js',
                options: {
                  hmr: false,
                  publicPath: '../'
                }
              ...
              /* config.module.rule('scss').oneOf('vue-modules').use('sass-loader') */
              {
                ...
                options: {
                  ...
                  implementation: {
                    ...
                    info: 'dart-sass\t1.43.2\t(Sass Compiler)\t[Dart]\ndart2js\t2.14.3\t(Dart Compiler)\t[Dart]',
                    render: function() {
        ...
        use: [
          /* config.module.rule('eslint').use('eslint-loader') */
          {
            ...
            options: {
              ...
              cache: true,
              cacheIdentifier: '5d8f777d',
              emitWarning: true,
              emitError: false,
              eslintPath: 'D:\\workspace\\Demo\\Vue\\hello-world\\node_modules\\eslint',
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: 'D:\\workspace\\Demo\\Vue\\hello-world\\public\\index.html'
      }
    ),
    ...
    new CopyWebpackPlugin(
      [
        {
          from: 'D:\\workspace\\Demo\\Vue\\hello-world\\public',
          to: 'D:\\workspace\\Demo\\Vue\\hello-world\\dist',
          toType: 'dir',
          ignore: [
            '.DS_Store',
            {
